...
export function TypesZodPage() {
    ...
    return (
        <div className="space-y-6">
            <PageHeader title="Gerador Types/Zod" description="Gere tipos TypeScript e schemas Zod a partir de JSON" />
            <div className="grid gap-6 lg:grid-cols-2">
                <Card className="p-4 space-y-3">
                    <div className="flex items-center justify-between">
                        <h3 className="font-semibold">Entrada JSON</h3>
                        <Button onClick={() => setInput('{"id":1, "name":"John", "email":"john@example.com", "tags":["a","b"]}')}>Exemplo</Button>
                    </div>
